...
func (c *exampleService) PostReg(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "Example.PostReg", in)
	out := new(Response)
...
func (h *exampleHandler) PostReg(ctx context.Context, in *Request, out *Response) error {
	return h.ExampleHandler.PostReg(ctx, in, out)
}
