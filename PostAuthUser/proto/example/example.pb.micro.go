...
type ExampleService interface {
	PostAuthUser(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error)
...
func NewExampleService(name string, c client.Client) ExampleService {
	...
	if len(name) == 0 {
		name = "go.micro.srv.PostAuthUser"
	}
...
func (c *exampleService) PostAuthUser(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "Example.PostAuthUser", in)
	out := new(Response)
...
type ExampleHandler interface {
	PostAuthUser(context.Context, *Request, *Response) error
...
func RegisterExampleHandler(s server.Server, hdlr ExampleHandler, opts ...server.HandlerOption) error {
	type example interface {
		PostAuthUser(ctx context.Context, in *Request, out *Response) error
...
func (h *exampleHandler) PostAuthUser(ctx context.Context, in *Request, out *Response) error {
	return h.ExampleHandler.PostAuthUser(ctx, in, out)
}
