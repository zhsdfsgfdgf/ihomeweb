...
const (
	...
	RECODE_DATAERR    = "4004"
	RECODE_DBREREP    = "4005"
	RECODE_DBNOUSER   = "4006"
	RECODE_DBREDISER  = "4007"
...
var recodeText = map[string]string{
	...
	RECODE_DATAERR:    "数据错误",
	RECODE_DBREDISER:  "redis连接出错",
	RECODE_DBREREP:    "该用户已存在,不能重复注册",
	RECODE_DBNOUSER:   "该用户未注册",
